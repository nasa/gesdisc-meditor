...
![mEditor home screen with login prompt](/meditor/docs/images/user-guide/quick-start__login-screen.png)
...
![mEditor splash screen with models, logged in](/meditor/docs/images/user-guide/quick-start__dashboard.png)
...
1. From the [Home screen](#meditor-home-screen) click on the "Users" model.
   ![Users model button](/meditor/docs/images/user-guide/quick-start__users-model-button.png)
...
![Model listing showing a list of Alerts documents](/meditor/docs/images/user-guide/quick-start__search-results.png)
...
![mEditor keyword search with "TRMM" entered](/meditor/docs/images/user-guide/quick-start__search-bar.png)
...
![mEditor Keyword search by model selection](/meditor/docs/images/user-guide/quick-start__search-bar-model-select.png)
