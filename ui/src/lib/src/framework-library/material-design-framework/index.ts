...
import { MaterialWysiwygComponent } from './material-wysiwyg.component';
...
export const MATERIAL_FRAMEWORK_COMPONENTS = [
  ...
  MaterialRadiosComponent, MaterialSelectComponent, MaterialSelectColorComponent,
  MaterialSliderComponent, MaterialStepperComponent, MaterialTabsComponent, 
  MaterialTextareaComponent, MaterialWysiwygComponent, MaterialDesignFrameworkComponent
];
...
export { MaterialWysiwygComponent } from './material-wysiwyg.component';
