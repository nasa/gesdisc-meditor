...
Your document is now saved and is in the "Draft" state. An initial version of the document is created in the [History](/user-guide/versions-and-history) panel. You can reopen the document to make additional [edits](#editing-a-document-and-submitting-it-for-review).

![Add form for FAQs model with "Save" button](/images/user-guide/working-with-documents__add-document.png)
...
1. First locate the document in the [list of documents](/user-guide/quick-start#viewing-documents) within the models type. Use the keyword search to filter the list making it easier to find your document.
...
1. Click "Save" to save your changes. Each save creates a new version in the [History](/user-guide/versions-and-history) panel.
...
1. Click on the "Comments" button to open the Comment panel and read the reviewer's comment(s). ![comment icon showing one comment](/images/user-guide/comment-icon--1.png)
1. If you need more information, reply to the reviewer's comment(s) by clicking the "Reply" button ![icon symbolizing "reply"](/images/user-guide/comment-reply-button.png)for each comment that needs further clarification and write a response.
1. If the reviewer's comment(s) provides enough detail, make edits based on their feedback.
1. Click "Submit for Review" button once you have satisfied all of the reviewer's comments with the document and are ready to have it re-reviewed. The document is saved and creates a new version in the [History](/user-guide/versions-and-history) panel. See [Submitting a Document for Review](#submitting-a-document-for-review) for more details.
   ![Edit form for FAQs model with "Comment" , "History" and "Submit for Review" buttons.](/images/user-guide/working-with-documents__edit-document.png)
...
1. Click on the "Comments" button to open the Comment panel and respond to any comments left by the author or publisher.
   ![comment icon showing one comment](/images/user-guide/comment-icon--1.png)
...
1. If you feel changes or additions need to be made, click the "Comment" button to open the Comment panel.
   ![comment icon showing no comments](/images/user-guide/comment-icon--0.png)
1. Click the "New comment" button and enter your suggested edits. Then either click the "Close" button or click outside the comment panel to hide comments.
