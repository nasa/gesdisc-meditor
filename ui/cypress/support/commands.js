const COMMAND_DELAY = process.env.NODE_ENV === 'development' ? 1500 : 500 // slow down commands to give NextJS a sec to compile the page (this avoids false errors)
...
Cypress.Commands.add(
    'uploadImage',
    { prevSubject: 'element' },
    (subject, imageName, type = 'image/png') => {
